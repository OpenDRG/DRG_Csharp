namespace drg_group.beijing_2022{
    public class RB2
    {
        public static String group(MedicalRecord record)
        {
            ...
            String[] adrg_zd1={};
            String[] adrg_ss={"99.2500x017","99.2500x036","99.2500x037","99.2502","99.2503","99.2504","99.2505","99.2506","99.2800x003","99.2801"};
            String[] adrg_ss1={};
            
            if (true && Base.intersect(record.zdList,adrg_zd) && record.ssList!=null &&record.ssList.Length>0 && adrg_ss.Contains(record.ssList[0])){
                Base.groupMessages.putMessage(record.Index,"符合RB2入组条件，匹配规则：某一诊断匹配、主手术匹配");
