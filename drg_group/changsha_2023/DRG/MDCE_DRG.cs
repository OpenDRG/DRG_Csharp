namespace drg_group.changsha_2023
{
    public class MDCE_DRG 
    {
        ...
        public static bool EB11_group(MedicalRecord record){
            return record.zdList.Length>1 && Base.has_mcc(record.Index,record.zdList[0],record.zdList[1..]);
        }
    
        public static bool EB21_group(MedicalRecord record){
            return record.zdList.Length>1 && Base.has_mcc(record.Index,record.zdList[0],record.zdList[1..]);
        }
        ...
        public static bool EB25_group(MedicalRecord record){
            return true;
        }
