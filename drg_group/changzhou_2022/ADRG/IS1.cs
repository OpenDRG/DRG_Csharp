    ...
    public class IS1
    {
        public static String group(MedicalRecord record)
        {
            ...
            if (true && adrg_zd.Contains(record.zdList[0])){
                ...
                if (MDCI_DRG.IS10_group(record))
                {
                    return "IS10";
                }
    
                if (MDCI_DRG.IS11_group(record))
                {
                    return "IS11";
                }
    
                if (MDCI_DRG.IS13_group(record))
                {
                    return "IS13";
                }
