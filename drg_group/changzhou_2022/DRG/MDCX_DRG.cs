namespace drg_group.changzhou_2022
{
    public class MDCX_DRG 
    {
        ...
        public static bool XS10_group(MedicalRecord record){
            return record.age<=17;
        }
    
        public static bool XS20_group(MedicalRecord record){
            return record.age<=17;
        }
    
        public static bool XT30_group(MedicalRecord record){
            return record.age<=17;
        }
