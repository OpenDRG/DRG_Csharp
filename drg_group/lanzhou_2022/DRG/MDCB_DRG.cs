namespace drg_group.lanzhou_2022
{
    public class MDCB_DRG 
    {
        ...
        public static bool BW21_group(MedicalRecord record){
            return record.zdList.Length>1 && Base.has_mcc(record.Index,record.zdList[0],record.zdList[1..]);
        }
        ...
        public static bool BE2A_group(MedicalRecord record){
        ...
        public static bool BX2A_group(MedicalRecord record){
            return record.zdList.Length>1 && (Base.has_mcc(record.Index,record.zdList[0],record.zdList[1..]) || Base.has_cc(record.Index,record.zdList[0],record.zdList[1..]));
        }
        ...
        public static bool BU1B_group(MedicalRecord record){
            return true;
        }
        ...
        public static bool BE25_group(MedicalRecord record){
            return true;
        }
        ...
        public static bool BX25_group(MedicalRecord record){
            return true;
        }
        ...
        public static bool BV1AA_group(MedicalRecord record){
        ...
        public static bool BV15A_group(MedicalRecord record){
            return record.age<14;
        }
    
        public static bool BV11B_group(MedicalRecord record){
            return record.zdList.Length>1 && Base.has_mcc(record.Index,record.zdList[0],record.zdList[1..]);
        }
    
        public static bool BV13B_group(MedicalRecord record){
            return record.zdList.Length>1 && (Base.has_mcc(record.Index,record.zdList[0],record.zdList[1..]) || Base.has_cc(record.Index,record.zdList[0],record.zdList[1..]));
        }
    
        public static bool BV15B_group(MedicalRecord record){
            return true;
        }
