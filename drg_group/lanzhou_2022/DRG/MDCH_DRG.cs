namespace drg_group.lanzhou_2022
{
    public class MDCH_DRG 
    {
        ...
        public static bool HC2A_group(MedicalRecord record){
        ...
        public static bool HJ1B_group(MedicalRecord record){
            return true;
        }
    
        public static bool HK1B_group(MedicalRecord record){
            return true;
        }
        ...
        public static bool HT1B_group(MedicalRecord record){
            return true;
        }
