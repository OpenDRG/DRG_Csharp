namespace drg_group.lanzhou_2022
{
    public class MDCI_DRG 
    {
        ...
        public static bool IC41_group(MedicalRecord record){
        ...
        public static bool IF4A_group(MedicalRecord record){
            return record.zdList.Length>1 && (Base.has_mcc(record.Index,record.zdList[0],record.zdList[1..]) || Base.has_cc(record.Index,record.zdList[0],record.zdList[1..]));
        }
        ...
        public static bool IV1A_group(MedicalRecord record){
            return record.zdList.Length>1 && (Base.has_mcc(record.Index,record.zdList[0],record.zdList[1..]) || Base.has_cc(record.Index,record.zdList[0],record.zdList[1..]));
        }
        ...
        public static bool IF1AA_group(MedicalRecord record){
        ...
        public static bool IF15A_group(MedicalRecord record){
            return record.age<14;
        }
    
        public static bool IF1AB_group(MedicalRecord record){
            return record.zdList.Length>1 && (Base.has_mcc(record.Index,record.zdList[0],record.zdList[1..]) || Base.has_cc(record.Index,record.zdList[0],record.zdList[1..]));
        }
    
        public static bool IF15B_group(MedicalRecord record){
            return true;
        }
