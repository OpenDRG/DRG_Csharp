namespace drg_group.lanzhou_2022
{
    public class MDCK_DRG 
    {
        ...
        public static bool KC1A_group(MedicalRecord record){
            return record.zdList.Length>1 && (Base.has_mcc(record.Index,record.zdList[0],record.zdList[1..]) || Base.has_cc(record.Index,record.zdList[0],record.zdList[1..]));
        }
    
        public static bool KD1A_group(MedicalRecord record){
            return record.zdList.Length>1 && (Base.has_mcc(record.Index,record.zdList[0],record.zdList[1..]) || Base.has_cc(record.Index,record.zdList[0],record.zdList[1..]));
        }
        ...
        public static bool KJ1B_group(MedicalRecord record){
            return true;
        }
        ...
        public static bool KT1AA_group(MedicalRecord record){
        ...
        public static bool KT15A_group(MedicalRecord record){
            return record.age<14;
        }
    
        public static bool KT11B_group(MedicalRecord record){
            return record.zdList.Length>1 && Base.has_mcc(record.Index,record.zdList[0],record.zdList[1..]);
        }
    
        public static bool KT13B_group(MedicalRecord record){
            return record.zdList.Length>1 && (Base.has_mcc(record.Index,record.zdList[0],record.zdList[1..]) || Base.has_cc(record.Index,record.zdList[0],record.zdList[1..]));
        }
    
        public static bool KT15B_group(MedicalRecord record){
            return true;
        }
