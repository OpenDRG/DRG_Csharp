namespace drg_group.lanzhou_2022
{
    public class MDCL_DRG 
    {
        ...
        public static bool LB1A_group(MedicalRecord record){
            return record.zdList.Length>1 && (Base.has_mcc(record.Index,record.zdList[0],record.zdList[1..]) || Base.has_cc(record.Index,record.zdList[0],record.zdList[1..]));
        }
    
        public static bool LE1A_group(MedicalRecord record){
            return record.zdList.Length>1 && (Base.has_mcc(record.Index,record.zdList[0],record.zdList[1..]) || Base.has_cc(record.Index,record.zdList[0],record.zdList[1..]));
        }
    
        public static bool LJ1A_group(MedicalRecord record){
            return record.zdList.Length>1 && (Base.has_mcc(record.Index,record.zdList[0],record.zdList[1..]) || Base.has_cc(record.Index,record.zdList[0],record.zdList[1..]));
        }
        ...
        public static bool LB2B_group(MedicalRecord record){
            return true;
        }
    
        public static bool LF1B_group(MedicalRecord record){
            return true;
        }
    
        public static bool LL1B_group(MedicalRecord record){
            return true;
        }
        ...
        public static bool LT1B_group(MedicalRecord record){
            return true;
        }
    
        public static bool LU1B_group(MedicalRecord record){
            return true;
        }
    
        public static bool LV1B_group(MedicalRecord record){
            return true;
        }
