namespace drg_group.lanzhou_2022
{
    public class MDCQ_DRG 
    {
        ...
        public static bool QB1A_group(MedicalRecord record){
            return record.zdList.Length>1 && (Base.has_mcc(record.Index,record.zdList[0],record.zdList[1..]) || Base.has_cc(record.Index,record.zdList[0],record.zdList[1..]));
        }
    
        public static bool QJ1A_group(MedicalRecord record){
            return record.zdList.Length>1 && (Base.has_mcc(record.Index,record.zdList[0],record.zdList[1..]) || Base.has_cc(record.Index,record.zdList[0],record.zdList[1..]));
        }
        ...
        public static bool QR1B_group(MedicalRecord record){
            return true;
        }
    
        public static bool QS2B_group(MedicalRecord record){
            return true;
        }
    
        public static bool QS4B_group(MedicalRecord record){
            return true;
        }
