namespace drg_group.qingyang_2023{
    public class JA1_2
    {
        public static String group(MedicalRecord record)
        {
            ...
            if (true && adrg_zd.Contains(record.zdList[0]) && record.ssList!=null &&record.ssList.Length>0 && Base.intersect(record.ssList,adrg_ss) && Base.intersect(record.ssList,adrg_ss1) && Base.intersect(record.ssList,adrg_ss2)){
