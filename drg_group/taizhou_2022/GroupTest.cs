...
namespace drg_group
{
    public class GroupTest
    {
        ...
        static void Main(string[] args)
        {
            ...
            // Console.WriteLine(grouper.group_record(new GroupProxy.GroupDelegate(Grouper_taizhou_2022.group),Common.replace_csv(str))); 
            // grouper.group_txt();
            // group();
        ...
        //     grouper.group_csv(new GroupDelegate(Grouper_taizhou_2022.group),filename,cols);
        // }
    }
}