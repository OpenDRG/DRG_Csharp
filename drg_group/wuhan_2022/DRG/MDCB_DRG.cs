namespace drg_group.wuhan_2022
{
    public class MDCB_DRG 
    {
        ...
        public static bool BM1A_group(MedicalRecord record){
            return record.zdList.Length>1 && (Base.has_mcc(record.Index,record.zdList[0],record.zdList[1..]) || Base.has_cc(record.Index,record.zdList[0],record.zdList[1..]));
        }
    
        public static bool BT1A_group(MedicalRecord record){
            return record.zdList.Length>1 && (Base.has_mcc(record.Index,record.zdList[0],record.zdList[1..]) || Base.has_cc(record.Index,record.zdList[0],record.zdList[1..]));
        }
        ...
        public static bool BB1B_group(MedicalRecord record){
            return true;
        }
    
        public static bool BD1B_group(MedicalRecord record){
            return true;
        }
    
        public static bool BJ1B_group(MedicalRecord record){
            return true;
        }
    
        public static bool BS1B_group(MedicalRecord record){
            return true;
        }
