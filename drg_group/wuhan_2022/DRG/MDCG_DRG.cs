namespace drg_group.wuhan_2022
{
    public class MDCG_DRG 
    {
        ...
        public static bool GB1A_group(MedicalRecord record){
        ...
        public static bool GE2A_group(MedicalRecord record){
            return record.zdList.Length>1 && (Base.has_mcc(record.Index,record.zdList[0],record.zdList[1..]) || Base.has_cc(record.Index,record.zdList[0],record.zdList[1..]));
        }
        ...
        public static bool GG1B_group(MedicalRecord record){
            return true;
        }
    
        public static bool GJ1B_group(MedicalRecord record){
            return true;
        }
    
        public static bool GK2B_group(MedicalRecord record){
            return true;
        }
