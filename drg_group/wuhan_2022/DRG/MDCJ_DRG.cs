namespace drg_group.wuhan_2022
{
    public class MDCJ_DRG 
    {
        ...
        public static bool JA2B_group(MedicalRecord record){
            return true;
        }
    
        public static bool JB1B_group(MedicalRecord record){
            return true;
        }
    
        public static bool JS1B_group(MedicalRecord record){
            return true;
        }
