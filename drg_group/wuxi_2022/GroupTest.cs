namespace drg_group
{
    public class GroupTest
    {
        ...
        static void Main(string[] args)
        {
            ...
            // Console.WriteLine(grouper.group_record(new GroupProxy.GroupDelegate(Grouper_suzhou_2022.group),Common.replace_csv(str))); 
        ...
        //     grouper.group_csv(new GroupDelegate(grouper_suzhou_2022.group),filename,cols);
        // }
    }
}