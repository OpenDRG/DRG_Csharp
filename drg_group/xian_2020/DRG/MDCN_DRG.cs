namespace drg_group.xian_2020
{
    public class MDCN_DRG 
    {
        ...
        public static bool NG11_group(MedicalRecord record){
        ...
        public static bool NG13_group(MedicalRecord record){
        ...
        public static bool NG15_group(MedicalRecord record){
            return true;
        }
